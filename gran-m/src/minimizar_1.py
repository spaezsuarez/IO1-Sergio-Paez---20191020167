...
objective_function = [1,-1,-3] # P = -x1 -x2 - x3
...
inecuations_right_side_restrictions = [6]
...
#Matriz con coeficientes de las restricciones, en este caso solo para las igualdades
equations_left_side_restriction = [
    [1,2,1],
    [0,1,1]
]

#Lista con los lados derechos de las restricciones nuevamente solo para las igualdades
equations_right_restriction = [4,1]
